                                ...
                                <div class="info-sidebar">
                                    <div class="info-card">
                                        ...
                                        <div class="info-card-body">
                                            <div class="role-info">
                                                <div class="role-header admin-role">
                                                ...
                                                <ul class="role-permissions">
                                                    <li class="permission-item">
                                                        ...
                                                        <span>التحكم الكامل في النظام</span>
                                                    </li>
                                                    <li class="permission-item">
                                                        <i class="fas fa-check-circle text-success me-2"></i>
                                            ...
                                            <div class="role-info mt-4">
                                                <div class="role-header editor-role">
                                                    <i class="fas fa-edit me-2 text-info"></i>
                                                    <h6 class="mb-0">محرر</h6>
                                                </div>
                                                <ul class="role-permissions">
                                                    <li class="permission-item">
                                                        <i class="fas fa-check-circle text-success me-2"></i>
                                                        <span>إدارة المقالات الخاصة به</span>
                                                    </li>
                                                    <li class="permission-item">
                                                        <i class="fas fa-check-circle text-success me-2"></i>
                                                    ...
                                                    <li class="permission-item">
                                                        <i class="fas fa-check-circle text-success me-2"></i>
                                                        <span>تعديل مقالاته فقط</span>
                                                    </li>
                                                    <li class="permission-item">
                                                        <i class="fas fa-times-circle text-danger me-2"></i>
                                                        <span>لا يمكنه إدارة المستخدمين</span>
                                                    </li>
                                                    <li class="permission-item">
                                                        <i class="fas fa-times-circle text-danger me-2"></i>
                                                        <span>لا يمكنه إدارة التصنيفات</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
